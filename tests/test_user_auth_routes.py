...
class UserAuthRouteSourceTests(unittest.TestCase):
    ...
    def test_user_site_dashboard_template_exists(self):
        ...
        self.assertIn("dashboard.traffic_sources.items", template_source)
        self.assertIn("dashboard.utm_campaigns.items", template_source)
        self.assertIn("Откуда пришли посетители", template_source)
